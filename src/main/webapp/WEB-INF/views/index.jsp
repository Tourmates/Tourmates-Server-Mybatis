  ...
  <div class="modal-dialog modal-dialog-centered">
    <form class="modal-content" method="post" action="${root}/login">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-outline-success" data-bs-target="#forgotLoginId" data-bs-toggle="modal">아이디찾기</button>
        <button type="button" class="btn btn-outline-secondary" data-bs-target="#forgotloginPw" data-bs-toggle="modal">비밀번호찾기</button>
      </div>
    </form>
  </div>
</div>
...
<div class="modal fade" id="forgotLoginId" aria-hidden="true" aria-labelledby="forgotLoginIdLable" tabindex="-1" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <form class="modal-content" method="post" action="${root}/forgot/loginId">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-secondary" data-bs-target="#loginModal" data-bs-toggle="modal">이전</button>
...
<div class="modal fade" id="forgotloginPw" aria-hidden="true" aria-labelledby="forgotloginPwLable" tabindex="-1" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
